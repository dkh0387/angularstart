...
export class DocumentsService {
    ...
    getAll() {
        const document1 = new Documents(GlobalConstants.document1, GlobalConstants.document1Url);
        this.setTranslatedDescriptionFor(GlobalConstants.document1DescriptionTranslateKey, document1);
        const document2 = new Documents(GlobalConstants.document2, GlobalConstants.document2Url);
        this.setTranslatedDescriptionFor(GlobalConstants.document2DescriptionTranslateKey, document2);
        const document3 = new Documents(GlobalConstants.document3, GlobalConstants.document3Url);
